...
htmlhelp_basename = 'timeoutpooldoc'
...
latex_documents = [
    (master_doc, 'timeoutpool.tex', 'smote\\_variants Documentation',
...
man_pages = [
    (master_doc, 'timeoutpool', 'timeoutpool Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'timeoutpool', 'timeoutpool Documentation',
     author, 'timeoutpool', 'One line description of project.',
     'Miscellaneous'),
]
